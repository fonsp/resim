...
namespace Resim.Program
{
	public partial class Game
	{
		public override void Resize(Rectangle newDimensions)
		{
			...
			ActionTrigger.textField.position = new Vector2((newDimensions.Width - ActionTrigger.textField.sizeX * ActionTrigger.textField.text.Length) / 2, (newDimensions.Height - ActionTrigger.textField.sizeY) * 2 / 3);
		}
	}
}